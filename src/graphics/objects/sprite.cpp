...
void SpriteBuffer::Buffer(std::vector<Sprite> &rectinfos) {
...
void SpriteBuffer::Draw(GLsizei count) {
    m_instancedBuffer.DrawArrays(GL_TRIANGLES, 0, sizeof(m_quadVertices) / sizeof(float) / 4, count);
}
